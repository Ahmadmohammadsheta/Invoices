                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right">{{ __('الاجمالي') }}</td>
                                        <td class="tx-right" colspan="2"> {{ number_format($Total, 2) }}</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-right">{{ __('نسبة الضريبة ') }}({{ $invoice->rate_vat }})</td>
                                        <td class="tx-right" colspan="2">{{ $Total * 10 / 100 }}</td>
                                    </tr>
                                    <tr>
                                        <td class="tx-right">{{ __('قيمة الخصم') }}</td>
                                        <td class="tx-right" colspan="2"> {{ number_format($invoice->discount, 2) }}</td>

                                    </tr>
                                    <tr>
                                        <td class="tx-right tx-uppercase tx-bold tx-inverse">{{ __('الاجمالي شامل الضريبة') }}</td>
