				...
				<div class="row row-sm">
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-24 text-white">{{ __('اجمالي الفواتير') }}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ __('$') . number_format($invoices->sum('total'), 2) }}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{ number_format($invoices->count(), 2) }}</p>
										</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-24 text-white">{{ __('فواتير اليوم') }}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ __('$') . number_format($today ? $today->sum('total') : '0', 2) }}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{ number_format(!empty($today) ?  $today->count() : 0, 2) }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">{{ number_format(!is_null($today) ?  $today->count() / $invoices->count() * 100 : '0', 2) . __('%') }}</span>
										</span>
									</div>
								</div>
							</div>
							<span id="compositeline2" class="pt-1">50,2,4,6,12,14,8,70,90,16,12,7,8,4,3,2,2,5,6,7</span>
						</div>
					</div>
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-24 text-white">{{ __('فواتير الامس') }}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ __('$') . number_format($yesterday->sum('total'), 2) }}</h4>
											<p class="mb-0 tx-12 text-white op-7">{{ number_format($yesterday->count(), 2) }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">{{ number_format($yesterday->count() / $invoices->count() * 100, 2) . __('%') }}</span>
										</span>
									</div>
								</div>
							</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-24 text-white">{{ __('وارد منتجات اليوم') }}</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">{{ number_format(count($productToday) > 0 ? $productToday->count() / $productToday->count() * 100 : 0, 2) . __('%') }}</span>
										</span>
									</div>
								</div>
							</div>
